...
while($row=mysql_fetch_assoc($query))
{
  ...
  if($row['ADS']!="") 
  {
    ...
    if($np>100 && $np<201) $link2=$link2."bibcode=".$row['ADS']."&";
    if($np>200 && $np<301) $link3=$link3."bibcode=".$row['ADS']."&";
	if($np>300) $link4=$link4."bibcode=".$row['ADS']."&";
  } else {
    continue;
  }
}
...
if($link!="")
{
  if($sort == "first author")
  {
	...
	if($link3!="") $test2xx=getthroughproxy("http://adsabs.harvard.edu/cgi-bin/abs_connect?".$link3."&nr_to_return=200&sort=AUTHOR&data_type=Custom&format=<li><small><b>%25Y</b>%20%25A%20<font%20color=green><i>%25T</i></font> %20 %25q,%25v,%25p %20<b>(Citations:%20%25c)</b>%20<a%20href=\"%25u\"%20target=blank>ADS%20Abstract</a></small><br><br>","wwwcache.dur.ac.uk","8080");
	if($link4!="") $test2xxx=getthroughproxy("http://adsabs.harvard.edu/cgi-bin/abs_connect?".$link4."&nr_to_return=200&sort=AUTHOR&data_type=Custom&format=<li><small><b>%25Y</b>%20%25A%20<font%20color=green><i>%25T</i></font> %20 %25q,%25v,%25p %20<b>(Citations:%20%25c)</b>%20<a%20href=\"%25u\"%20target=blank>ADS%20Abstract</a></small><br><br>","wwwcache.dur.ac.uk","8080");
  ...
  }else
  {
    ...
    {     
	  ...
	  if($link3!="") $test2xx=getthroughproxy("http://adsabs.harvard.edu/cgi-bin/abs_connect?".$link3."&nr_to_return=200&sort=NDATE&data_type=Custom&format=<li><small><b>%25Y</b>%20%25A%20<font%20color=green><i>%25T</i></font> %20 %25q,%25v,%25p %20<b>(Citations:%20%25c)</b>%20<a%20href=\"%25u\"%20target=blank>ADS%20Abstract</a></small><br><br>","wwwcache.dur.ac.uk","8080");
      if($link4!="") $test2xxx=getthroughproxy("http://adsabs.harvard.edu/cgi-bin/abs_connect?".$link4."&nr_to_return=200&sort=NDATE&data_type=Custom&format=<li><small><b>%25Y</b>%20%25A%20<font%20color=green><i>%25T</i></font> %20 %25q,%25v,%25p %20<b>(Citations:%20%25c)</b>%20<a%20href=\"%25u\"%20target=blank>ADS%20Abstract</a></small><br><br>","wwwcache.dur.ac.uk","8080");
	...
	if($link3!="") $test2xx=getthroughproxy("http://adsabs.harvard.edu/cgi-bin/abs_connect?".$link3."&nr_to_return=200&sort=CITATIONS&data_type=Custom&format=<li><small><b>%25Y</b>%20%25A%20<font%20color=green><i>%25T</i></font> %20 %25q,%25v,%25p %20<b>(Citations:%20%25c)</b>%20<a%20href=\"%25u\"%20target=blank>ADS%20Abstract</a></small><br><br>","wwwcache.dur.ac.uk","8080");
     if($link4!="") $test2xxx=getthroughproxy("http://adsabs.harvard.edu/cgi-bin/abs_connect?".$link4."&nr_to_return=200&sort=CITATIONS&data_type=Custom&format=<li><small><b>%25Y</b>%20%25A%20<font%20color=green><i>%25T</i></font> %20 %25q,%25v,%25p %20<b>(Citations:%20%25c)</b>%20<a%20href=\"%25u\"%20target=blank>ADS%20Abstract</a></small><br><br>","wwwcache.dur.ac.uk","8080");
      }
      else
      {
	$test2=getthroughproxy("http://adsabs.harvard.edu/cgi-bin/abs_connect?".$link."&nr_to_return=200&sort=NDATE&data_type=Custom&format=<li><small><b>%25Y</b>%20%25A%20<font%20color=green><i>%25T</i></font> %20 %25q,%25v,%25p %20<b>(Citations:%20%25c)</b>%20<a%20href=\"%25u\"%20target=blank>ADS%20Abstract</a></small><br><br>","wwwcache.dur.ac.uk","8080");
  ...
  if($link3!="") $test2xx['content']=highlight($test2xx['content'],$_POST['string']);
  if($link4!="") $test2xxx['content']=highlight($test2xxx['content'],$_POST['string']);
  print "$test2[content]\n";
  if($link2!="") print "$test2x[content]\n";
  if($link3!="") print "$test2xx[content]\n";
  if($link4!="") print "$test2xxx[content]\n";
  print "</ol>";
} else
{
